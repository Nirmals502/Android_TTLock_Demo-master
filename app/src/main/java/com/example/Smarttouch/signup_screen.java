...
import com.example.Smarttouch.activity.AuthActivity;

import com.example.Smarttouch.app.Config;
import com.example.Smarttouch.constant.Configg;
...
//                            R.anim.slide_out_left);
                    ...
                    //final String str_email = Str_email.replaceAll("@gmail.com", "");

                    String[] parts = Str_email.split("@");
                    str_email = parts[0];//"hello"
                    new AsyncTask<Void, Integer, String>() {
                        @Override
                        protected void onPreExecute() {
                            super.onPreExecute();
                            dialog = new ProgressDialog(signup_screen.this);
                        ...
                        protected String doInBackground(Void... params) {
                            return ResponseService.register(str_email, Str_password);
                        }

                        //
                        @Override
                        protected void onPostExecute(String json) {
                            String msg = "Server is slow";
                            if (dialog.isShowing()) {
                                dialog.dismiss();
                            }
                            try {
                                ...
                                if (jsonObject.has("errcode")) {
                                    ...
                                    Toast.makeText(signup_screen.this, msg, Toast.LENGTH_LONG).show();
                                } else {
                                    Registration_id = jsonObject.getString("username");
//                                    //msg = getString(R.string.words_authorize_successed);
                                    Toast.makeText(signup_screen.this, "we are creating an account....", Toast.LENGTH_LONG).show();
                                    new signup().execute();
...
//                            // toast(msg);
    ...
    private class signup extends AsyncTask<Void, String, Void> implements DialogInterface.OnCancelListener {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            nameValuePairs.add(new BasicNameValuePair("registeration_id", Registration_id));
