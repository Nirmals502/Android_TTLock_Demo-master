...
import com.example.Smarttouch.adapter.KeyAdapter;
...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    String accesstocken = "", StrLOckid = "";
    /**
     * 访问令牌
     */
    private String accessToken = "", Deviceid = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            if (extras == null) {
                ...
                newString = extras.getString("LOCKFOUNDED");
            }
        } else {
            newString = (String) savedInstanceState.getSerializable("LOCKFOUNDED");
        }
//        if(newString.contentEquals("LOCKFOUNDED")){

//        }
    }

    private class CREATE_LOCK extends AsyncTask<Void, String, Void> implements DialogInterface.OnCancelListener {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            nameValuePairs.add(new BasicNameValuePair("lockid", curKey.getLockName()));
            nameValuePairs.add(new BasicNameValuePair("address", userInput.getText().toString()));


            String jsonStr = sh.makeServiceCall_withHeader(SERVER.Create_LOck,
            ...
            if (jsonStr != null) {
                ...
                try {
                    ...
                    if (status.contentEquals("true")) {
                        ...
                        StrLOckid = jsonObj_data.getString("id");
        ...
        protected void onPostExecute(Void result) {
            ...
            if (status.contentEquals("true")) {
                ...
                editor.putString("Lock_created", curKey.getLockName());
                editor.putString("lockid", StrLOckid);
    ...
    private void init() {
        ...
        LogUtil.d("Request location permission", DBG);
        //Request location permission to successfully open Bluetooth
...
//        keyAdapter.notifyDataSetChanged();
    ...
    void onItemClick(int position) {
        ...
        String str_Check_lockstatus = "";
        SharedPreferences pref = getSharedPreferences("Smart_touch", MODE_PRIVATE);
        str_Check_lockstatus = pref.getString("Lock_created", "nodata");
        if (str_Check_lockstatus.contentEquals(curKey.getLockName())) {
            if (curKey.isAdmin()) {
                //curKey.getLockName();
                // Toast.makeText(this, curKey.getLockName(), Toast.LENGTH_LONG).show();
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                    MainActivity.this);
            // set title
            alertDialogBuilder.setTitle(curKey.getLockName());
            // set custom dialog icon
            alertDialogBuilder.setIcon(R.drawable.logog);
            // set custom_dialog.xml to alertdialog builder
            alertDialogBuilder.setView(dialogView);
            userInput = (EditText) dialogView
                            ...
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog,
                                    ...
                                    if (userInput.getText().toString().contentEquals("")) {
                                        //  alertDialog.
                                        toast("Please enter Lock address");
                                    } else {
                                        new CREATE_LOCK().execute();
                                    }
...
//        menu.setHeaderTitle(R.string.words_lock);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == 0) {
            new AsyncTask<Void, String, String>() {
                ...
                protected void onPreExecute() {
                    super.onPreExecute();
                    mTTLockAPI.resetLock(null, openid, key.getLockVersion(), key.getAdminPs(), key.getUnlockKey(), key.getLockFlagPos() + 1, key.getAesKeystr());
                }
                ...
                protected void onPostExecute(String msg) {
                    ...
                    editor.remove("Lock_created");
                    editor.remove("lockid");
    ...
    protected void onDestroy() {
        super.onDestroy();
        LogUtil.d("Turn off Bluetooth service", DBG);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_add) {
            toast("Touch any Key to Activate the Keyboard");
...
//                startActivity(intent);
                ...
                editor.commit();
                Intent intentt = new Intent(MainActivity.this, AuthActivity.class);
...
//                        DbService.saveKey(key);
    ...
    public void open() {
        ...
        alertDialogBuilder.setMessage("Smart Touch lock, the best way to keep you in touch with your most valued asset- your clients");
