...
import com.example.Smarttouch.databinding.ActivityDeviceFirmwareUpdateBinding;
import com.example.Smarttouch.dialog.MultiButtonDialog;
    ...
    public void showUpgradeDialog() {
        ...
        dialog.setPositiveClickListener(new MultiButtonDialog.PositiveClickListener() {
            ...
            public void onPositiveClick(String inputContent) {
                dialog.cancel();
                showProgressDialog();
                deviceFirmwareUpdateApi.upgradeFirmware(Configg.CLIENT_ID, MyPreference.getStr(MyApplication.mContext, MyPreference.ACCESS_TOKEN),
