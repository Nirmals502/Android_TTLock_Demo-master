...
public class ResponseService {
    ...
    public static String auth(String username, String password) {
        ...
        params.put("client_id", Configg.CLIENT_ID);
        params.put("client_secret", Configg.CLIENT_SECRET);
        params.put("grant_type", "password");
        params.put("username", username);
        params.put("password", DigitUtil.getMD5(password));
        params.put("redirect_uri", Configg.REDIRECT_URI);
    ...
    public static String register(String username, String password) {
        ...
        HashMap params = new HashMap();
        params.put("clientId", Configg.CLIENT_ID);
        params.put("clientSecret", Configg.CLIENT_SECRET);
        //  params.put("grant_type", "password");
        params.put("username", username);
        params.put("password", DigitUtil.getMD5(password));
    ...
    public static String UNLOCK_REMOTELY(int lockId) {
        String url = actionUrlV3 + "/lock/unlock";
        HashMap params = new HashMap();
        params.put("clientId", Configg.CLIENT_ID);
        params.put("accessToken", MyPreference.getStr(MyApplication.mContext, MyPreference.ACCESS_TOKEN));
        params.put("lockId", String.valueOf(lockId));
